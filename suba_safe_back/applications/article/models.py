...
class Article(TimeStampedModel):
    ...
    main_image_opt_text = models.CharField('Texto alt. Principal',max_length=50)
    image_1 = models.ImageField('Imagen 2', upload_to='articles/optional', blank=True, null=True)
    image_1_opt_text = models.CharField('Texto alt. 2', max_length=50, blank=True, null=True)
    image_2 = models.ImageField('Imagen 3', upload_to='articles/optional', blank=True, null=True)
    image_2_opt_text = models.CharField('Texto alt. 3',max_length=50, blank=True, null=True)
    image_3 = models.ImageField('Imagen 4', upload_to='articles/optional', blank=True, null=True)
    image_3_opt_text = models.CharField('Texto alt. 4',max_length=50, blank=True, null=True)
    image_4 = models.ImageField('Imagen 5', upload_to='articles/optional', blank=True, null=True)
    image_4_opt_text = models.CharField('Texto alt. 5',max_length=50, blank=True, null=True)
